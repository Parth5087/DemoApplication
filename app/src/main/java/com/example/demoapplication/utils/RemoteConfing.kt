...
object RemoteConfigHelper {
    ...
    private const val UPLOAD_INTERVAL_SEC  = "upload_interval_sec"
    ...
    fun init(app: Application) {
        ...
        val defaults = mapOf(
            ...
            UPLOAD_INTERVAL_SEC  to 60L,
            WEBP_QUALITY         to 80L,
            WEBP_MAX_DIM         to 1200L,
            AUTO_UPLOAD_ENABLED  to true,
            START_DESTINATION    to "auto_photo_capture"
        )
    ...
    fun uploadIntervalMs(): Long {
        val sec = rc.getLong(UPLOAD_INTERVAL_SEC)
    ...
    private fun logAll(prefix: String = "RC") {
        ...
        Log.d("RC-SRC", "[$prefix] $UPLOAD_INTERVAL_SEC=${rc.getLong(UPLOAD_INTERVAL_SEC)} src=${srcName(UPLOAD_INTERVAL_SEC)}")
